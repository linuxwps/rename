...
- [ ] **CHAIN-01**: 用户可以通过规则列表添加多个重命名规则
- [ ] **CHAIN-02**: 用户可以拖拽调整规则顺序
- [ ] **CHAIN-03**: 规则从左到右依次应用到文件名
- [ ] **CHAIN-04**: 用户可为每个规则独立配置参数
- [ ] **CHAIN-05**: 链式操作支持实时预览，展示最终结果
- [ ] **CHAIN-06**: 每条规则的变更在预览中均有差异化高亮
- [ ] **CHAIN-07**: 规则数量限制为 10 个
